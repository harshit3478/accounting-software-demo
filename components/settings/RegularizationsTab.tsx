...
export default function RegularizationsTab({
  showSuccess,
  showError,
}: RegularizationsTabProps) {
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">
          Review and manage employee regularization requests
        </p>
      </div>
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                {items.map((it, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3 capitalize text-gray-900 text-xs">
                      {it.type}
                    </td>
