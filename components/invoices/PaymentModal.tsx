  ...
  const handleRecordPayment = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        return {
          success: false,
          error: error.error || "Failed to record payment",
        };
      }
    } catch (error) {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Available Store Credit:</span>
              <span className="font-semibold text-emerald-700">
                ${currentStoreCredit.toFixed(2)}
              </span>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div className="text-sm flex-1">
                  ...
                  <p className="text-blue-700 mt-1">
                    Recording ${paymentAmount.toFixed(2)} via{" "}
                  ...
                  {paymentAmount > remainingBalance && (
                    <p className="text-emerald-700 font-medium mt-2 flex items-center">
                      ...
                      Excess ${(paymentAmount - remainingBalance).toFixed(2)}{" "}
