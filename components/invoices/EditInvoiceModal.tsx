...
export default function EditInvoiceModal({
  ...
  const hasLayawayReconfigurationChanged = Boolean(
    invoice?.isLayaway &&
      ...
      (layawayMonths !== Number(invoice.layawayPlan?.months || 3) ||
        ...
        layawayNotes.trim() !==
          String(invoice.layawayPlan?.notes || "").trim()),
  );
  ...
  const handleUpdateInvoice = async (
    ...
    if (shouldOfferRemovedDepositFee && !effectiveRemovedDepositFeeAction) {
    ...
    if (shouldOfferRecalculationFee && !effectiveRecalculationFeeAction) {
      setShowRemovedDepositFeeModal(false);
              ...
              <label className="inline-flex items-start gap-3 text-sm text-indigo-950">
                ...
                <span>
                  ...
                  <span className="mt-1 block text-indigo-800">
                    ...
                    removed-item deposit fees, or layaway recalculation fees.
                    The edit is tagged in audit history with who made the
                    change.
                  </span>
                </span>
              </label>
            ...
            <div className="mt-6 flex flex-wrap justify-end gap-3">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  handleUpdateInvoice(undefined, "skip");
                }}
                className="rounded-lg border border-amber-300 bg-amber-50 px-4 py-2 text-sm font-medium text-amber-800 hover:bg-amber-100"
                disabled={isUpdating}
              >
              ...
              <button
                ...
                onClick={() => {
                  ...
                  handleUpdateInvoice(undefined, "apply");
                }}
